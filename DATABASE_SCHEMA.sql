...
CREATE TABLE aliments (
  ...
  -- Metadata
  is_popular BOOLEAN DEFAULT false,          -- Show in onboarding quick-add
...
-- Benefits with evidence rating per aliment
CREATE TABLE aliment_benefits (
  ...
  goal_tags TEXT[] DEFAULT '{}',             -- ["energy", "sleep", "focus"]
...
-- Interactions between aliments (and optionally medications)
CREATE TABLE interactions (
  ...
  aliment_b_name TEXT,                       -- For medications not in aliment table
  ...
  separation_hours INTEGER,                  -- If timing_separation, hours apart
  source_ref TEXT,
...
-- Public read access for encyclopedia data
